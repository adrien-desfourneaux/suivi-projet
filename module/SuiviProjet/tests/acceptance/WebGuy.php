...
class WebGuy extends \Codeception\AbstractGuy
{
    ...
    * Conditional Assertion: Test won't be stopped on fail
     ...
     * {@inheritdoc}
    * Conditional Assertion: Test won't be stopped on fail
     * @see Codeception\Module\WebHelper::seeProjectMarked()
     * @return \Codeception\Maybe
     */
    public function canSeeProjectMarked($projectDisplayName) {
        $this->scenario->addStep(new \Codeception\Step\ConditionalAssertion('seeProjectMarked', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    public function seeProjectMarked($projectDisplayName) {
        $this->scenario->addStep(new \Codeception\Step\Assertion('seeProjectMarked', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     * {@inheritdoc}
     * @see Codeception\Module\WebHelper::haveAllSuiviProjetDefaultsInDatabase()
     * @return \Codeception\Maybe
     */
    public function haveAllSuiviProjetDefaultsInDatabase() {
        $this->scenario->addStep(new \Codeception\Step\Action('haveAllSuiviProjetDefaultsInDatabase', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
